...
def checkifwon():
    ...
    if b1["text"] == "X" and b2["text"] == "X" and b3["text"] == "X":
        ...
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Toc", "PARABENS X")
        disable_all_buttons()
        ...
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Toc", "PARABENS O")
        disable_all_buttons()
    ...
    if count == 9 and winner == False:
        messagebox.showinfo("Tic Tac", "É um empate!!!")
        disable_all_buttons()
...
def b_click(b):
    ...
    if b["text"] == " " and clicked == True:
        ...
        messagebox.showerror("Tic Tac",
                             "Essa caixa já esta preenchida, escolhe outra por favor")
